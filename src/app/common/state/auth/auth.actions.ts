...
export const loginSuccess = createAction('[AUTH] Login Success', props<JwtReponse>());
...
export const refreshFailure = createAction('[AUTH] Refresh Failure', props<JwtReponse>());

export const signupRequest = createAction('[AUTH] Signup Request', props<User>());

export const signupSuccess = createAction('[AUTH] Signup Success', props<JwtReponse>());

export const signupFailure = createAction('[AUTH] Signup Failure', props<JwtReponse>());
